...
- Phase 1: prose. Not started. Pilot chapter (Volume I Chapter 1) is the named next move, per `docs/diagnostic.md`. Estimated several years of writing across general editor and named domain leads (settled question 50).
