...
% subcooled-liquid warming: 46 C at q=0 up to 295 C (sat) at q=1145
\addplot[engblue, very thick] coordinates {(0,46) (1145,295)};
% two-phase boiling plateau at 295 C, q from 1145 to 1145+1442=2587
\addplot[engred, very thick] coordinates {(1145,295) (2587,295)};
% superheating dry vapour: 295 C at q=2587 up to 500 C at q=3199
\addplot[engorange, very thick] coordinates {(2587,295) (3199,500)};
...
\node[anchor=south west, font=\scriptsize, engblue] at (axis cs:20,120)
  {liquid warming};
\node[anchor=south, font=\scriptsize, engred] at (axis cs:1850,300)
  {boiling: constant $T_{\mathrm{sat}}$};
\node[anchor=west, font=\scriptsize, engorange] at (axis cs:2850,430)
  {superheat};
% endpoint markers
\addplot[engblack, only marks, mark=*, mark size=1.5pt] coordinates {
  (0,46) (1145,295) (2587,295) (3199,500)
};
\end{axis}
\end{tikzpicture}
