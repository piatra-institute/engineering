...
\texttt{volumes/02-form/ch18-mathematical-modelling/figures/} (eleven
TikZ figures, including the Buckingham-Pi data collapse, the SIR
compartment diagram, the Kleiber log-log scaling line, and the
thermal-mass model-revision pair); \texttt{code/} (nine Python scripts:
