...
modelling), uncertainty, scaling, balance, optimisation. Exercise target: 25. Project
...
\texttt{volumes/02-form/ch18-mathematical-modelling/figures/} (fourteen
...
staffing-cost optimisation pair, and the model-selection penalised-fit
curve); \texttt{code/} (nine Python scripts:
