...
\input{volumes/02-form/ch18-mathematical-modelling/figures/fig-buckingham-collapse.tex}
...
\input{volumes/02-form/ch18-mathematical-modelling/figures/fig-scaling-loglog.tex}
...
\input{volumes/02-form/ch18-mathematical-modelling/figures/fig-compartment-sir.tex}
...
\input{volumes/02-form/ch18-mathematical-modelling/figures/fig-model-selection.tex}
...
residuals, plotted against time, are not random. They are systematically
...
residual structure is not noise to be covered by a wider interval. It is
the next model's specification. The room has at least two thermal
...
\input{volumes/02-form/ch18-mathematical-modelling/figures/fig-thermal-mass-revision.tex}
...
\input{volumes/02-form/ch18-mathematical-modelling/figures/fig-queue-state.tex}
...
\input{volumes/02-form/ch18-mathematical-modelling/figures/fig-queue-validation.tex}
...
The sensitivity apparatus of section 18.4 makes the dominance concrete.
...
$\partial PV/\partial r$, is roughly $\tilde S_r \approx -4$ at these
values: a one-percent relative change in $r$ (from $8.00\%$ to
$8.08\%$) moves the present value by about four percent. The discount
rate is the dominant lever, and its uncertainty is the one the report
must expose. A modeller who anchors $C$ to three significant figures
from operating data while leaving $r$ as an unexamined $8\%$ has
measured the negligible term and assumed the dominant one. The
...
tolerances, which the tornado diagram of section 18.4 ranks. The
...
\input{volumes/02-form/ch18-mathematical-modelling/figures/fig-network-contagion.tex}
...
\input{volumes/02-form/ch18-mathematical-modelling/figures/fig-feedback-loop.tex}
...
\input{volumes/02-form/ch18-mathematical-modelling/figures/fig-montecarlo-propagation.tex}
...
\input{volumes/02-form/ch18-mathematical-modelling/figures/fig-pipe-friction-collapse.tex}
...
\input{volumes/02-form/ch18-mathematical-modelling/figures/fig-michaelis-menten.tex}
...
\input{volumes/02-form/ch18-mathematical-modelling/figures/fig-reactor-abstraction.tex}
...
\input{volumes/02-form/ch18-mathematical-modelling/figures/fig-recursive-estimation.tex}
...
\input{volumes/02-form/ch18-mathematical-modelling/figures/fig-reservoir-reliability.tex}
...
\input{volumes/02-form/ch18-mathematical-modelling/figures/fig-battery-soc.tex}
...
\input{volumes/02-form/ch18-mathematical-modelling/figures/fig-similarity-collapse.tex}
...
\input{volumes/02-form/ch18-mathematical-modelling/figures/fig-traffic-fundamental.tex}
...
\input{volumes/02-form/ch18-mathematical-modelling/figures/fig-fatigue-life.tex}
...
\input{volumes/02-form/ch18-mathematical-modelling/figures/fig-bias-variance.tex}
