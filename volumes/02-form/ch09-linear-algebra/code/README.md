...
| `leveling_adjustment.py` | Weighted least-squares adjustment of the spirit-levelling network of section 9.6: builds the incidence design matrix, solves by weighted normal equations and by QR on the whitened system, propagates the covariance, and prints per-run residuals (the $B\to D$ run flags as a blunder). | Section 9.6 worked case study. |
