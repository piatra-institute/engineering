...
\begin{scope}[shift={(8, 0)}]
  ...
  % max(0, .) clamps the radicand: at the domain endpoints x*x - c is zero in
  % exact arithmetic but rounds slightly negative in floating point, which
  % otherwise trips a pgfmath negative-square-root error.
