...
Four of the book's ten recurring problem archetypes make their first
...
The remaining six archetypes (transport, stability, optimisation,
control, interface, ethics) appear from Volume II onwards. The reader
can read this list with the comfortable knowledge that the book's
conceptual machinery will arrive gradually, in the chapters where the
