...
% TODO (Vol VI pass): ALL SEVEN figure files for this chapter were never
% created (the authoring agent hit a session limit), so every figure \input
% below is commented out to keep the book building. The prose does not
% cross-reference them, so no \ref breaks. Draw the figures during the Vol VI
% production pass and uncomment each \input.
...
% \input{volumes/06-life/ch09-synthetic-biology-metabolic-engineering/figures/fig-toggle-switch-state}  % figure pending (Vol VI pass): file not created
...
% \input{volumes/06-life/ch09-synthetic-biology-metabolic-engineering/figures/fig-repressilator}  % figure pending (Vol VI pass): file not created
...
% \input{volumes/06-life/ch09-synthetic-biology-metabolic-engineering/figures/fig-metabolic-flux}  % figure pending (Vol VI pass): file not created
...
% \input{volumes/06-life/ch09-synthetic-biology-metabolic-engineering/figures/fig-crispr-mechanism}  % figure pending (Vol VI pass): file not created
...
% \input{volumes/06-life/ch09-synthetic-biology-metabolic-engineering/figures/fig-pace-pipeline}  % figure pending (Vol VI pass): file not created
...
% \input{volumes/06-life/ch09-synthetic-biology-metabolic-engineering/figures/fig-bsl-containment}  % figure pending (Vol VI pass): file not created
