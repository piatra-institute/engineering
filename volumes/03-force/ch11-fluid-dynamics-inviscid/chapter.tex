...
the momentum theorem (jet impingement, sudden expansion) and the
rotating-frame pressure balance (the forced vortex); a third group
works the superposition machinery harder (the Rankine half-body, the
thin-airfoil camber line as a vortex sheet, the unsteady oscillating
column, and the free-streamline contraction of a jet); the section
closes with three end-to-end studies, a Venturi metering station and a
finite-wing induced-drag analysis, in which the relations of the
chapter are strung together into a sized result. A reader who follows
every step here can apply the inviscid toolkit to any configuration
that meets the five Bernoulli assumptions, and can recognise from the
momentum-theorem examples how the analysis continues when one of them
fails.
