...
which the two cancel, $\alpha_{L=0} = -2h/c$ (in radians). A section
with two percent camber ($h/c = 0.02$) carries $\alpha_{L=0} =
-0.04\,\text{rad} = -2.29^\circ$, meaning it still lifts at zero
geometric angle of attack, $C_L = 4\pi\times 0.02 = 0.251$, which is
...
0.0915))} = \sqrt{125.9} = 11.2$, and $Q = 0.97\times 5.35\times
10^{-3}\times 11.2 \approx 0.058\,\text{m}^3/\text{s}$, recovering $60\,\text{L/s}$ to within the
