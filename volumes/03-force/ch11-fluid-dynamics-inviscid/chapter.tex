...
rotating-frame pressure balance (the forced vortex); the section closes
with two end-to-end design studies, an unsteady tank drain and a
Venturi metering station, in which the relations of the chapter are
strung together into a sized result. A reader who follows every step
here can apply the inviscid toolkit to any configuration that meets the
five Bernoulli assumptions, and can recognise from the momentum-theorem
