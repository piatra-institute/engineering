...
$\tfrac{1}{2}mv_{G}^{2}(1+k^{2}/R^{2})$, so a hoop carries as much energy in
spin as in translation while a sphere carries only two-fifths.
...
=\sqrt{9.81\times 120\times 0.995}=34.2\,\si{\meter\per\second},
\]
...
(0.1405+0.18)/(1-0.18\times 0.1405)}=19.7\,\si{\meter\per\second}$
($71\,\si{\kilo\meter\per\hour}$), so the posted advisory speed on a
...
\input{volumes/03-force/ch04-dynamics-and-newtons-laws/figures/fig-friction-circle.tex}
...
\input{volumes/03-force/ch04-dynamics-and-newtons-laws/figures/fig-block-on-block.tex}
...
\input{volumes/03-force/ch04-dynamics-and-newtons-laws/figures/fig-bead-sphere.tex}
...
\input{volumes/03-force/ch04-dynamics-and-newtons-laws/figures/fig-bounce-series.tex}

\input{volumes/03-force/ch04-dynamics-and-newtons-laws/figures/fig-spin-gravity.tex}

\input{volumes/03-force/ch04-dynamics-and-newtons-laws/figures/fig-pulled-spool.tex}
...
\input{volumes/03-force/ch04-dynamics-and-newtons-laws/figures/fig-tmd-response.tex}
...
\input{volumes/03-force/ch04-dynamics-and-newtons-laws/figures/fig-jet-vane.tex}
