...
- 3816-page PDF. Vol I at Tier 3 second pass complete (9-agent parallel rollout + three main-thread deepening turns + two 3-agent follow-up waves + one 3-agent closer wave, 2026-05-31 / 06-02), 720/720 pp = **100.0% target density**. Vol II at Tier 1+2 across 17 of 18 chapters, with Ch 2 still at first-draft pending re-run.
...
- 817 bibliography entries.
- 40 named-case registry entries; 38 `acc:` keys cited in prose; `make accidents` PASS.
...
- `make check`, `make audit-docs`, `make accidents`, `make exercise-counts` all PASS. `make distclean && make` produces a clean 3816-page PDF.
