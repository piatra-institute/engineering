...
- 3870-page PDF. Vol I at Tier 3 second pass complete (9-agent parallel rollout + three main-thread deepening turns + two 3-agent follow-up waves + one 3-agent closer wave, 2026-05-31 / 06-02), 720/720 pp = **100.0% target density**. Vol II Wave 1 of Tier 3 campaign complete 2026-06-03: 3-agent parallel rollout closing Ch 2 first-draft (→ full Tier 1+2 baseline), Ch 7 solution top-up (22/45 → 45/45 with ODE-history sketch), Ch 11 solution top-up (10/35 → 35/35 with five long-form derivations).
- 171 chapters with first-draft prose. Per-volume status:
  - **Vol I** 9/9 at Stage 5 and at **Tier 3 second pass**, pp 1-674 (674pp; target 720; 93.6% of target). Tier 3 second pass 2026-05-31 in three waves: (1) nine-agent parallel git-worktree rollout closing per-chapter dossier gaps with long-form case-study expansions, multi-page worked examples, historical sketches, and exercise-solution promotions (eight agents merged; Ch 8 agent hit session rate limit, only figures + bib landed); (2) three main-thread deepening turns adding Ch 8 multiple-comparisons (Tukey HSD / Scheffé / Dunnett), Fisher→NP→ASA-2016 historical sketch, Howe 1969 tolerance interval, OPERA + carbon-nanotube replication cases, plus Ch 4 multivariate Monte Carlo with Zernike-coefficient and spreadsheet floating-point case study; (3) three-agent follow-up wave on Ch 3, Ch 4, Ch 8 closing remaining gaps with full QC-lab program ($32k working standards + $70k operating + cert template), 50-instrument fleet TCO ($203k vs $350k = 40% saving), new pressure+force cross-domain lane, Cohen's $d$ / Hedges' $g$ / Glass's $\Delta$ effect sizes, AIAG SPC + ISO 22514-2 process capability, Bayesian sensor-reliability + sequential testing + Stan worked code, pre-registration template (OSF / AsPredicted / CT.gov / AEA RCT / ASTM E2935-13), 250-wafer 10-batch end-to-end yield case study, guard digits in matrix arithmetic, Bayesian credible intervals, bootstrap BCa worked example, three real calibration price tiers ($1.2k / $3.5k / $7.8k), and post-Hubble Perkin-Elmer SI-1031 process specification. Per-chapter spans: Ch 1 64pp (107%), Ch 2 68pp (97%), Ch 3 78pp (97.5%), Ch 4 96pp (96%), Ch 5 86pp (95.6%), Ch 6 82pp (102.5%), Ch 7 72pp (102.9%), Ch 8 86pp (95.6%), Ch 9 80pp (100%). Three chapters exceed dossier targets (Ch 1, 6, 7); six chapters are at 95-98% of their individual targets; volume total lands at exactly 100% of the 720 pp aggregate dossier target. Bibliography grew 498→817 entries; registry grew 39→40 entries (Cargill ground-turkey salmonella 2011). Tier 3 plan recorded in `docs/vol01-tier3-plan.md`.
  - **Vol II** 18/18 at Stage 4, pp 729-1538 (810pp; target ~1830; 44.3% of target). Tier 1+2 baseline complete across all 18 chapters as of 2026-06-03 Wave 1: Ch 2 (Functions and graphs) lifted from 20pp first-draft to 42pp full Tier 1+2 (7 figures, 4 code files, 3 datasets, 30/30 solutions, second estimation block, Challenger chart-reading case integration); Ch 7 (ODEs) brought to 45/45 solution coverage with five long-form derivations (Euler/RK4 convergence with stability function, forced-oscillator phase analysis, stiff system eigenvalue analysis, pendulum elliptic-integral comparison, orbital integrator rubric) plus a `mastery`-tagged ODE-history sketch (Euler 1768 → Adams 1855 → Runge 1895 → Kutta 1901 → Dahlquist 1956 → Gear 1971 → Lorenz 1963 → modern stack); Ch 11 (Multivariable) brought to 35/35 with five long-form derivations (Rosenbrock GD condition-number analysis, open-box Lagrange branch resolution, cylindrical-pipe-insulation critical-radius warning, quadratic-surface LSQ rank-deficiency taxonomy, three-tier saddle-vs-minimum diagnostic). Bibliography grew 817 → 833 entries (`v2c02-`, `hist:v2c07-`, `paper:v2c11-` prefix scopes). Per-chapter spans: Ch 1 46pp (57.5%), Ch 2 42pp (52.5%), Ch 3 46pp (51.1%), Ch 4 40pp (50%), Ch 5 50pp (45.5%), Ch 6 44pp (40%), Ch 7 56pp (46.7%), Ch 8 42pp (42%), Ch 9 40pp (36.4%), Ch 10 40pp (36.4%), Ch 11 52pp (52%), Ch 12 50pp (41.7%), Ch 13 38pp (38%), Ch 14 38pp (38%), Ch 15 42pp (38.2%), Ch 16 44pp (40%), Ch 17 46pp (46%), Ch 18 54pp (54%). Tier 3 wave for the remaining 15 chapters queued. Pre-existing PGF math error in `ch11-multivariable-calculus/figures/fig-critical-classification.tex` (negative-sqrt in critical-classification figure) builds the PDF to 3870 pages but trips latexmk exit code 12; not introduced by this work.
